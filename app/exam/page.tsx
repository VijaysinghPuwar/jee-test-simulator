...
export default function ExamPage() {
  ...
  return (
    <main className="flex h-screen flex-col bg-slate-100 dark:bg-slate-950">
      ...
      <div className="flex items-center gap-1 border-b border-slate-200 bg-white px-6 dark:border-slate-800 dark:bg-slate-900">
        {SUBJECTS.map((s) => {
          ...
          return (
            ...
            >
              {s} <span className="ml-1 text-xs text-slate-400 dark:text-slate-500">({count})</span>
              {active && (
      ...
      <div className="grid flex-1 grid-cols-1 overflow-hidden lg:grid-cols-[1fr_320px]">
        <section className="flex flex-col overflow-hidden bg-white dark:bg-slate-900">
          <QuestionView
          ...
          />
          <div className="flex flex-wrap items-center justify-between gap-2 border-t border-slate-200 bg-slate-50 px-6 py-3 dark:border-slate-800 dark:bg-slate-950/70">
